# What's new in Helm Charts Version 3.0.4 for IBM Sterling B2B Integrator Enterprise Edition v6.2.0.2
...
* Tech stack upgrades
    ...
    Red Hat OpenShift Container Platform 4.14 and 4.15 or later fixes
    Kubernetes versions >=1.27 and < =1.29
    Helm version 3.14.x
