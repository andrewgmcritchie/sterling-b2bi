...
{{- if .Values.application.server.grpcMaxConnectionAge -}}
{{- $maxConnectionAgeValid := include "documentService.integerValidation" .Values.application.server.grpcMaxConnectionAge -}}
{{- if eq $maxConnectionAgeValid "false" -}}
{{- fail "Provide a valid integer value for grpcMaxConnectionAge." -}}
{{- end -}}
{{- end -}}
