...
{{- if not ( or (eq $resourcesPVCEnabled "false") (eq $resourcesPVCEnabled "true")) -}}
{{- fail "Please provide correct value for .Values.appResourcesPVC.enabled. Value can be either false or true." -}}
{{- end -}}
...
{{- if not ( or (eq $documentsPVCEnabled "false") (eq $documentsPVCEnabled "true")) -}}
{{- fail "Please provide correct value for .Values.appDocumentsPVC.enabled. Value can be either false or true." -}}
{{- end -}}
...
{{- end -}}
{{- if and (or (eq $logsPVCEnabled "true") (not .Values.logs.enableAppLogOnConsole)) (empty .Values.appLogsPVC.preDefinedLogsPVCName) -}}
...
{{- $defaultDocStorageType := upper .Values.setupCfg.defaultDocumentStorageType  -}}
{{- if and (eq $defaultDocStorageType "OS") (eq $isServiceEnabled "false") -}}
{{- fail "When .Values.setupCfg.defaultDocumentStorageType is set to OS, Document service should be enabled i.e. .Values.documentService.enabled should be true" -}}
{{- end -}}
{{- end -}}
{{- if eq $isServiceEnabled "true" -}}
	...
	{{- if .Values.documentService.grpcPoolSize -}}
        {{- $result := include "integerValidation" .Values.documentService.grpcPoolSize -}}
        {{- if eq $result "false" -}}
        {{- fail "Provide a valid value for .Values.documentService.grpcPoolSize" -}}
        {{- end -}}
    {{- end -}}
	{{- if .Values.documentService.keepAliveGrpc -}}
        {{- $result := include "integerValidation" .Values.documentService.keepAliveGrpc -}}
        {{- if eq $result "false" -}}
        {{- fail "Provide a valid value for .Values.documentService.keepAliveGrpc" -}}
        {{- end -}}
    {{- end -}}
...
{{- $isEnabled := .Values.integrations.itxaIntegration.resourcesInit.enabled | toString -}}
{{- if not ( or (eq $isEnabled "false") (eq $isEnabled "true")) -}}
{{- fail "Please provide valid value for Values.integrations.itxaIntegration.resourcesInit.enabled. Value can be either false or true." -}}
{{- end -}}

{{- if (eq $isEnabled "true") -}}

{{- $result := include "mandatoryArgumentsCheck" .Values.integrations.itxaIntegration.resourcesInit.image.repository -}}
{{- if eq $result "false" -}}
{{- fail ".Values.integrations.itxaIntegration.resourcesInit.image.repository cannot be empty." -}}
{{- end -}}

{{- if not .Values.integrations.itxaIntegration.resourcesInit.image.digest -}}
{{- $result := include "mandatoryArgumentsCheck" .Values.integrations.itxaIntegration.resourcesInit.image.tag -}}
{{- if eq $result "false" -}}
{{- fail "Please specify either .Values.integrations.itxaIntegration.resourcesInit.image.tag or .Values.integrations.itxaIntegration.resourcesInit.image.digest " -}}
{{- end -}}
{{- end -}}

{{- $result := include "mandatoryArgumentsCheck" .Values.integrations.itxaIntegration.resourcesInit.image.pullPolicy -}}
{{- if eq $result "false" -}}
{{- fail ".Values.integrations.itxaIntegration.resourcesInit.image.pullPolicy cannot be empty." -}}
{{- else -}}
{{- $result := .Values.integrations.itxaIntegration.resourcesInit.image.pullPolicy -}}
{{- if not (or (eq $result "IfNotPresent") (eq $result "Always") (eq $result "Never")) -}}
{{- fail ".Values.integrations.itxaIntegration.resourcesInit.image.pullPolicy is not valid. Valid values are IfNotPresent , Always or Never" -}}
{{- end -}}
{{- end -}}
